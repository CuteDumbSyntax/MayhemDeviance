...
namespace MayhemDeviance.Common.Systems
{
	...
	{
		public static bool ArgunBoss = false;
		public static bool MaxBoss = false;
		public static bool CIBoss = false;
		...
		public override void LoadWorldData(TagCompound tag) {
			ArgunBoss = tag.ContainsKey("ArgunBoss");
			MaxBoss = tag.ContainsKey("MaxBoss");
			CIBoss = tag.ContainsKey("CIBoss");
