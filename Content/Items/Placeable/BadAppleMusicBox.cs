using MayhemDeviance.Content.Tiles;
using Terraria.ID;
using Terraria.ModLoader;

namespace MayhemDeviance.Content.Items.Placeable
{
	public class BadAppleMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/BadApple"), ModContent.ItemType<BadAppleMusicBox>(), ModContent.TileType<BadAppleMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<BadAppleMusicBoxTile>(), 0);
		}
	}
}