...
namespace MayhemDeviance.Content.Items.Placeable.Furniture
{
	public class MayhemCatRelic : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.MayhemCatRelic>(), 0);
