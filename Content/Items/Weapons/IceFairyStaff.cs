...
using MayhemDeviance.Content.Projectiles.Minions;
namespace MayhemDeviance.Content.Items.Weapons
{
	public class IceFairyStaff : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.buffType = ModContent.BuffType<IceFairyStaffBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<IceFairyMinion>(); // This item creates the minion projectile
		}
