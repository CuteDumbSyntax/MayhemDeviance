...
namespace MayhemDeviance.Content.Projectiles
{
	...
	public class ShatteredLoveSw : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Main.rand.NextFloat() * 2f < Projectile.Opacity) {
				...
				Color dustColor = Color.Lerp(Color.LightPink, Color.Pink, Main.rand.NextFloat() * 0.3f);
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color backDarkColor = new Color(204, 0, 104); 
			Color middleMediumColor = new Color(255, 204, 255); 
			Color frontLightColor = new Color(255, 153, 204); 
