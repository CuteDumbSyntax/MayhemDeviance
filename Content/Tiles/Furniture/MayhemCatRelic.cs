...
namespace MayhemDeviance.Content.Tiles.Furniture
{
	...
	public class MayhemCatRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "MayhemDeviance/Content/Tiles/Furniture/MayhemCatRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "MayhemDeviance/Content/Tiles/Furniture/RelicPedestal";
